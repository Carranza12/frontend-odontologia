...
import { PerfilMaestroComponent } from '../maestro/pages/perfil-maestro/perfil-maestro.component';
...
const routes: Routes = [
  ...
  { path: 'maestros/perfil-maestro/:id', canActivate: [SuperAdminGuard], component: PerfilMaestroComponent }
];
