...
export class HistoriaClinicaEditComponent implements OnInit {
  ...
  public paises = [{ value: 'México', text: 'México' }];
  ...
  ngOnInit(): void {
    ...
    this._route.params.subscribe((param) => {
        ...
        this.apiSevice.getHistoriaClinica(this.historia_clinica_id).subscribe(
          (response: any) => {
            ...
            this.historiaClinicaForm
              .get('nombre_completo')
              ?.setValue(response?.item?.paciente?.nombre_completo);
            /*Valor de la fecha de nacimiento*/
            const fechaNacimiento =
              response?.item?.paciente?.fecha_de_nacimiento;
            ...
            if (this.isEditHistoria) {
              this.firmaImagenShow =
                response?.item?.historia_clinica?.firmaPaciente;
              this.firmaImagen =
                response?.item?.historia_clinica?.firmaPaciente;
            }
            this.historiaClinicaForm
              .get('fecha_de_nacimiento')
              ?.setValue(response?.item?.paciente?.fecha_de_nacimiento);
            this.historiaClinicaForm
              .get('nombre_tutor')
              ?.setValue(response?.item?.historia_clinica?.nombre_tutor);
            this.historiaClinicaForm
              .get('genero')
              ?.setValue(response?.item?.paciente?.genero);
            this.historiaClinicaForm
              .get('estado_civil')
              ?.setValue(response?.item?.paciente?.estado_civil);
            this.historiaClinicaForm
              .get('ocupacion')
              ?.setValue(response?.item?.paciente?.ocupacion);
            this.historiaClinicaForm
              .get('domicilio')
              ?.setValue(response?.item?.paciente?.domicilio);
            this.historiaClinicaForm
              .get('telefono')
              ?.setValue(response?.item?.paciente?.telefono);
            this.historiaClinicaForm
              .get('ciudad_origen')
              ?.setValue(response?.item?.paciente?.ciudad_origen);
            this.historiaClinicaForm
              .get('estado_origen')
              ?.setValue(response?.item?.paciente?.estado_origen);
            this.historiaClinicaForm
              .get('pais_origen')
              ?.setValue(response?.item?.paciente?.pais_origen);
            this.historiaClinicaForm
              .get('ciudad_Actual')
              ?.setValue(response?.item?.paciente?.ciudad_Actual);
            this.historiaClinicaForm
              .get('nombre_contacto_emergencia')
              ?.setValue(response?.item?.paciente?.nombre_contacto_emergencia);
            this.historiaClinicaForm
              .get('parentesco_contacto_emergencia')
              ?.setValue(
                response?.item?.paciente?.parentesco_contacto_emergencia
              );
            this.historiaClinicaForm
              .get('telefono_contacto_emergencia')
              ?.setValue(
                response?.item?.paciente?.telefono_contacto_emergencia
              );

            this.historiaClinicaForm
              .get('antecedentes_hereditarios')
              ?.setValue(
                response?.item?.historia_clinica?.antecedentes_hereditarios
              );
            this.historiaClinicaForm
              .get('alcoholismo')
              ?.setValue(response?.item?.historia_clinica?.alcoholismo);
            ...
            this.historiaClinicaForm
              .get('tabaquismo')
              ?.setValue(response?.item?.historia_clinica?.tabaquismo);
            this.historiaClinicaForm
              .get('toxicomanias')
              ?.setValue(response?.item?.historia_clinica?.toxicomanias);
            this.historiaClinicaForm
              .get('higiene')
              ?.setValue(response?.item?.historia_clinica?.higiene);
            this.historiaClinicaForm
              .get('alimentacion')
              ?.setValue(response?.item?.historia_clinica?.alimentacion);
            this.historiaClinicaForm
              .get('condicion')
              ?.setValue(response?.item?.historia_clinica?.condicion);
            this.historiaClinicaForm
              .get('socioconomia')
              ?.setValue(response?.item?.historia_clinica?.socioconomia);
            this.historiaClinicaForm
              .get('habitos')
              ?.setValue(response?.item?.historia_clinica?.habitos);
            this.historiaClinicaForm
              .get('ant_personales_otros_textarea')
              ?.setValue(
                response?.item?.historia_clinica?.ant_personales_otros_textarea
              );
            this.historiaClinicaForm
              .get('padecimiento_principio')
              ?.setValue(
                response?.item?.historia_clinica?.padecimiento_principio
              );
            this.historiaClinicaForm
              .get('padecimiento_evolucion')
              ?.setValue(
                response?.item?.historia_clinica?.padecimiento_evolucion
              );
            this.historiaClinicaForm
              .get('padecimiento_estado_actual')
              ?.setValue(
                response?.item?.historia_clinica?.padecimiento_estado_actual
              );
            this.historiaClinicaForm
              .get('ant_personales_p_otros_textarea')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.ant_personales_p_otros_textarea
              );

            this.historiaClinicaForm
              .get('enf_infancia')
              ?.setValue(response?.item?.historia_clinica?.enf_infancia);
            this.historiaClinicaForm
              .get('Fimicos')
              ?.setValue(response?.item?.historia_clinica?.Fimicos);
            this.historiaClinicaForm
              .get('Lueticos')
              ?.setValue(response?.item?.historia_clinica?.Lueticos);
            this.historiaClinicaForm
              .get('Diabeticos')
              ?.setValue(response?.item?.historia_clinica?.Diabeticos);
            this.historiaClinicaForm
              .get('Quirurgicos')
              ?.setValue(response?.item?.historia_clinica?.Quirurgicos);
            this.historiaClinicaForm
              .get('Traumaticos')
              ?.setValue(response?.item?.historia_clinica?.Traumaticos);
            this.historiaClinicaForm
              .get('Ictericos')
              ?.setValue(response?.item?.historia_clinica?.Ictericos);
            this.historiaClinicaForm
              .get('Epilepticos')
              ?.setValue(response?.item?.historia_clinica?.Epilepticos);
            this.historiaClinicaForm
              .get('Alergicos')
              ?.setValue(response?.item?.historia_clinica?.Alergicos);
            this.historiaClinicaForm
              .get('Reumaticos')
              ?.setValue(response?.item?.historia_clinica?.Reumaticos);
            this.historiaClinicaForm
              .get('Transfusiones')
              ?.setValue(response?.item?.historia_clinica?.Transfusiones);
            this.historiaClinicaForm
              .get('Enfermedades_Cardiovasculares')
              ?.setValue(
                response?.item?.historia_clinica?.Enfermedades_Cardiovasculares
              );
            this.historiaClinicaForm
              .get('Incidencia_de_Infecciones_Bucales')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.Incidencia_de_Infecciones_Bucales
              );
            this.historiaClinicaForm
              .get('Neoplasticas')
              ?.setValue(response?.item?.historia_clinica?.Neoplasticas);
            this.historiaClinicaForm
              .get('SIDA')
              ?.setValue(response?.item?.historia_clinica?.SIDA);

            this.historiaClinicaForm
              .get('aparatos_sistemas_digestivo_apetito')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_digestivo_apetito
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_digestivo_Masticacion')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_digestivo_Masticacion
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_digestivo_Deglucion')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_digestivo_Deglucion
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_digestivo_Disfagia')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_digestivo_Disfagia
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_digestivo_Nauseas')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_digestivo_Nauseas
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_digestivo_Vomito')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_digestivo_Vomito
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_digestivo_Dolor_Abdominal')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_digestivo_Dolor_Abdominal
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_digestivo_Hematemsis')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_digestivo_Hematemsis
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_digestivo_Pirosis')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_digestivo_Pirosis
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_digestivo_Meteorismo')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_digestivo_Meteorismo
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_digestivo_Diarrea')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_digestivo_Diarrea
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_digestivo_Estrenimiento')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_digestivo_Estrenimiento
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_digestivo_Melena')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_digestivo_Melena
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_digestivo_Rectorragia')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_digestivo_Rectorragia
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_digestivo_Otros')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_digestivo_Otros
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_digestivo_Otros_textarea')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_digestivo_Otros_textarea
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_respiratorio_Epistasis')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_respiratorio_Epistasis
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_respiratorio_Tos')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_respiratorio_Tos
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_respiratorio_Disnea')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_respiratorio_Disnea
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_respiratorio_Expectoracion')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_respiratorio_Expectoracion
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_respiratorio_Asma')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_respiratorio_Asma
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_respiratorio_Dolor_al_respirar')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_respiratorio_Dolor_al_respirar
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_respiratorio_Disfonia')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_respiratorio_Disfonia
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_respiratorio_Gripa_frecuente')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_respiratorio_Gripa_frecuente
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_respiratorio_Otros')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_respiratorio_Otros
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_respiratorio_Otros_textarea')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_respiratorio_Otros_textarea
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_circulatorio_Disnea_del_esfuerzo')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_circulatorio_Disnea_del_esfuerzo
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_circulatorio_Dolor_retroesternal')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_circulatorio_Dolor_retroesternal
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_circulatorio_Palpitaciones')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_circulatorio_Palpitaciones
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_circulatorio_Edema')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_circulatorio_Edema
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_circulatorio_Lipotimias')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_circulatorio_Lipotimias
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_circulatorio_Calambres')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_circulatorio_Calambres
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_circulatorio_Cianosis')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_circulatorio_Cianosis
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_circulatorio_Acufenos')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_circulatorio_Acufenos
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_circulatorio_Fosfenos')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_circulatorio_Fosfenos
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_circulatorio_Otros')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_circulatorio_Otros
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_circulatorio_Otros_textarea')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_circulatorio_Otros_textarea
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_genito_urinario_Frecuencia_de_micciones')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_genito_urinario_Frecuencia_de_micciones
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_genito_urinario_Color')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_genito_urinario_Color
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_genito_urinario_Diuria')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_genito_urinario_Diuria
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_genito_urinario_Nicturia')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_genito_urinario_Nicturia
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_genito_urinario_Hematuria')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_genito_urinario_Hematuria
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_genito_urinario_Poliuria')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_genito_urinario_Poliuria
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_genito_urinario_Otros')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_genito_urinario_Otros
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_genito_urinario_Otros_textarea')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_genito_urinario_Otros_textarea
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_sist_nervioso_Ansiedad')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_sist_nervioso_Ansiedad
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_sist_nervioso_Temor')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_sist_nervioso_Temor
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_sist_nervioso_Convulciones')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_sist_nervioso_Convulciones
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_sist_nervioso_Paralisis')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_sist_nervioso_Paralisis
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_sist_nervioso_Temblores')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_sist_nervioso_Temblores
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_sist_nervioso_Tics')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_sist_nervioso_Tics
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_sist_nervioso_Vista')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_sist_nervioso_Vista
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_sist_nervioso_Oido')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_sist_nervioso_Oido
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_sist_nervioso_Tacto')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_sist_nervioso_Tacto
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_sist_nervioso_Otros')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_sist_nervioso_Otros
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_sist_nervioso_Otros_textarea')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_sist_nervioso_Otros_textarea
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_sintomas_generales_Variacion_de_peso')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_sintomas_generales_Variacion_de_peso
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_sintomas_generales_Astenia')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_sintomas_generales_Astenia
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_sintomas_generales_Adinamia')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_sintomas_generales_Adinamia
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_sintomas_generales_Fiebre')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_sintomas_generales_Fiebre
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_sintomas_generales_Escalofrios')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_sintomas_generales_Escalofrios
              );
            ...
            this.historiaClinicaForm
              .get('aparatos_sistemas_sintomas_generales_Anorexia')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_sintomas_generales_Anorexia
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_sintomas_generales_otros')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_sintomas_generales_otros
              );
            this.historiaClinicaForm
              .get('aparatos_sistemas_sintomas_generales_otros_textarea')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.aparatos_sistemas_sintomas_generales_otros_textarea
              );
            this.historiaClinicaForm
              .get('exploracion_fisica_raza_sexo_edad_facies_estado_conciencia')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.exploracion_fisica_raza_sexo_edad_facies_estado_conciencia
              );
            ...
            this.historiaClinicaForm
              .get('exploracion_fisica_signos_vitales')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.exploracion_fisica_signos_vitales
              );
            this.historiaClinicaForm
              .get('exploracion_fisica_TA')
              ?.setValue(
                response?.item?.historia_clinica?.exploracion_fisica_TA
              );
            this.historiaClinicaForm
              .get('exploracion_fisica_frec_respiratoria')
              ?.setValue(
                response?.item?.historia_clinica
                  ?.exploracion_fisica_frec_respiratoria
              );
            this.historiaClinicaForm
              .get('exploracion_fisica_temperatura')
              ?.setValue(
                response?.item?.historia_clinica?.exploracion_fisica_temperatura
              );
            this.historiaClinicaForm
              .get('exploracion_fisica_peso')
              ?.setValue(
                response?.item?.historia_clinica?.exploracion_fisica_peso
              );
            ...
            this.apiSevice
              .getTratamientosByHistoriaClinicaID(this.historia_clinica_id)
              .subscribe((respuesta: any) => {
                this.tratamientosList = respuesta.items;
                let nuevosTratamientos: any = [];

                this.tratamientosList = this.tratamientosList.map(
                  (tratamiento) => {
                    let maestroData = {};

                    if (
                      tratamiento.maestro_id &&
                      tratamiento.maestro_id !== 'RECHAZADO'
                    ) {
                      this.apiSevice
                        .getMaestroPerfil(tratamiento.maestro_id)
                        .subscribe((res: any) => {
                          if (res) {
                            maestroData = res;
                            this.apiSevice
                              .getUser(tratamiento.maestro_id)
                              .subscribe((resUser: any) => {
                                ...
                                nuevosTratamientos.push({
                                  ...tratamiento,
                                  diagnosticoItem: this.diagnosticosList.find(
                                    (d: any) =>
                                      d._id === tratamiento.diagnostico_id
                                  ),
                                  maestroData,
                                });
                                return;
                      ...
                      nuevosTratamientos.push({
                        ...tratamiento,
                        diagnosticoItem: this.diagnosticosList.find(
                          (d: any) => d._id === tratamiento.diagnostico_id
                        ),
                        maestroData,
                      });
                      return;
      ...
      this.historiaClinicaForm.controls.estado_origen.valueChanges.subscribe(
        (res: any) => {
    ...
    this.historiaClinicaForm.controls.fecha_de_nacimiento.valueChanges.subscribe(
      (valor: any) => {
    ...
    this.historiaClinicaForm.controls.Diabeticos.valueChanges.subscribe(
      (valor: any) => {
        if (valor) {
    ...
    this.historiaClinicaForm.controls.alcoholismo.valueChanges.subscribe(
      (valor: any) => {
        if (valor) {
    ...
    this.historiaClinicaForm.controls.tabaquismo.valueChanges.subscribe(
      (valor: any) => {
        if (valor) {
          this.esFumador = true;
        } else {
    ...
    this.historiaClinicaForm.controls.Epilepticos.valueChanges.subscribe(
      (valor: any) => {
        if (valor) {
    ...
    this.historiaClinicaForm.controls.Reumaticos.valueChanges.subscribe(
      (valor: any) => {
        if (valor) {
    ...
    this.historiaClinicaForm.controls.Alergicos.valueChanges.subscribe(
      (valor: any) => {
        if (valor) {
  ...
  public onSubmit() {
    ...
    const item = {
      ...
      paciente: {
        ...
        fecha_de_nacimiento: this.historiaClinicaForm.get('fecha_de_nacimiento')
          ?.value,
        ...
        nombre_contacto_emergencia: this.historiaClinicaForm.get(
          'nombre_contacto_emergencia'
        )?.value,
        parentesco_contacto_emergencia: this.historiaClinicaForm.get(
          'parentesco_contacto_emergencia'
        )?.value,
        telefono_contacto_emergencia: this.historiaClinicaForm.get(
    ...
    this.apiSevice
      .updateHistoriaClinica(this.historia_clinica_id, item)
      .subscribe(
        (response: any) => {
  ...
  public otroCheckbox() {
    this.historiaClinicaForm
      .get('aparatos_sistemas_digestivo_Otros')
      ?.valueChanges.subscribe((valor: any) => {
  ...
  public OpenDiagnosticoForm() {
    ...
    setTimeout(() => {
      this._router.navigateByUrl(
        `estudiante/diagnostico/${this.historia_clinica_id}`
      );
      this.loadingService.hide();
    }, 500);
  }

  public OpenDiagnosticoViewForm(
